...
Options:
  -f, --format string      choose log format. ("bank","apache_common"|"apache_combined"|"apache_error"|"rfc3164"|"rfc5424") (default "apache_common")
...
var validFormats = []string{"bank" ,"apache_common", "apache_combined", "apache_error", "rfc3164", "rfc5424", "common_log"}
